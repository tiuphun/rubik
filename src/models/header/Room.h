...
public:
    ...
    Room(int id, int created_by, time_t created_at, int max_players, int max_spectators, RoomStatus status, vector<GameSession> game_session, int current_players = 0, int current_spectators = 0)
        :  id(id), created_by(created_by), created_at(created_at), max_players(max_players), max_spectators(max_spectators), status(status), current_players(current_players), current_spectators(current_spectators), game_sessions(game_session) {}
